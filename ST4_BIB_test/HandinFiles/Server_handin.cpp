...
void setupBLE() {
  ...
  pCharacteristic_start = pService->createCharacteristic(CHARACTERISTIC_UUID_START, BLECharacteristic::PROPERTY_NOTIFY);

    // Create a BLE Characteristic for stop
  pCharacteristic_stop = pService->createCharacteristic(CHARACTERISTIC_UUID_STOP, BLECharacteristic::PROPERTY_NOTIFY);
